  ...
  <div>
    ...
    try {
      ...
      echo UIView::wrap(__data__::createDataCaptureForm($thispage, "Service", array(
        array("pname" => "serviceName", "id" => "sname", "required" => true, "caption" => "Name of Service", "placeholder" => "Service Name") ,
        array("pname" => "comments", "id" => "scomment", "type" => "textarea", "caption" => "My Comment"),
        array("pname" => "countable", "id" => "scount", "caption" => "Count Me"),
        array("pname" => "category", "id" => "scategory", "caption" => "Category Name"),
        array("id" => "sdiagnosis", "use-class" => "WorkingDiagnosis", "pname" => "listOfDiseases", "required" => false, "caption" => "Working Diagnosis", "items-count" => array("maximum" => 100), "include-columns" => array("icd10Code" => array("caption" => "ICD 10 Code"), "whoFullDescription" => array("caption" => "Description (WHO)")))
      ), "Push to Saver", "create", $conn, 0, array(),null, null, "hello-world", $thispage, true));
