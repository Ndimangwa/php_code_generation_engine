...
--><div class="col-md-10 offset-md-1 mx-auto">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    DETAILS OF PHARMACEUTICAL DRUG
                </div>
                <div class="card-body">
<?php
    $conn = null;
    $nextPage = $thispage."?page=pharmaceuticaldrug";
    $cname = "pharmaceuticaldrug_read";
    try {
        $conn = new PDO("mysql:host=$host;dbname=$dbname", $config1->getUsername(), $config1->getPassword());
        $id = $_GET['id'];
        echo __data__::createDetailsPage($thispage, "PharmaceuticalDrug", array(
            'drugName',
            'amount',
            'currency',
            'unitOfMeasurement'
        ), $conn, $_GET['id'], array(
            array("pname" => "amount", "classname" => "Service"),
            array("pname" => "currency", "classname" => "Service")
        ));
    } catch (Exception $e)  {
