            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    try {
                        ...
                        $query = "SELECT q.queueId as queueId, q.timeOfUpdation as timeOfUpdation, registrationNumber, surname, otherNames, visitCount FROM _patient_drug_queue as q, _patient as p, _patientVisit as v, _patientCase as c WHERE (q.visitId = v.visitId) AND (q.caseId = c.caseId) AND (q.patientId = p.patientId) AND (q.pendingPayment = 0) AND (q.completed = 0)";
