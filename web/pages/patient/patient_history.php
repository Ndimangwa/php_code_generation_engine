        ...
        <div class="col-md-10 offset-md-1 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <?php
                    $conn = null;
                    $nextPage = $thispage . "?page=patient_read&id=".$_GET['id'];
                    try {
                        $conn = new PDO("mysql:host=$host;dbname=$dbname", $config1->getUsername(), $config1->getPassword());
                        $patient1 = new Patient("Delta Init", $_GET['id'], $conn);
                    ?>
                        <div class="fluid-container">
                            <?= PatientFile::getPatientHistory($conn, $patient1, $profile1, $login1) ?>
                        </div>
                    <?php
                    } catch (Exception $e) {
                ...
                <div class="card-footer">
                    <div class="text-center">
                        <i><a href="<?= $nextPage ?>" class="card-link">Back to Patient Details</a></i><br />
