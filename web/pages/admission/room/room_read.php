...
<?php
    ...
    try {
        ...
        $id = $_GET['id'];
        $formToDisplay = __data__::createDetailsPage($nextPage, "Room", array('roomNumber', 'ward', 'observation', 'private', 'comments'), $conn, $id, null);
        echo $formToDisplay;
    } catch (Exception $e)  {
...
?>
                ...
                <div class="card-footer">
                    <div class="text-center">
                        <i><a href="<?= $nextPage ?>" class="card-link">Back to Room</a></i><br/>
                        <span class="text-muted"><i>Rule: room_read</i></span>
                    </div>
                </div>
            </div>
        </div>
