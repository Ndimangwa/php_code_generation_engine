...
<?php
    ...
    try {
        ...
        $formToDisplay = __data__::createDataCaptureForm($nextPage, "Ward", array(
            array('pname' => 'wardNumber', 'caption' => 'Ward Number', 'required' => true, 'placeholder' => '102'),
            array('pname' => 'comments', 'caption' => 'Comments', 'required' => false, 'placeholder' => 'In 1st floor')
        ), "Update a Ward","update", $conn, $_GET['id'], array(
            '__id__' => $_GET['id'], 
            '__modal_title__' => 'Ward Updation Report',
...
?>
                ...
                <div class="card-footer">
                    <div class="text-center">
                        ...
                        <span class="text-muted"><i>Rule: ward_update</i></span>
                    </div>
                </div>
            </div>
        </div>
