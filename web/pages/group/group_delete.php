...
<?php
    ...
    try {
        ...
        $formToDisplay = __data__::createConfirmationForm($nextPage, "Group", "You are about to delete permanently, a user Group; NOTE: This Action is irreversible", "Delete Group" , "delete", $conn, $_GET['id'], array('__id__' => $_GET['id'], '__modal_title__' => 'Delete Confirmation Report'), null);
        echo $formToDisplay;
    } catch (Exception $e)  {
...
?>
                ...
                <div class="card-footer">
                    <div class="text-center">
                        ...
                        <span class="text-muted"><i>Rule: group_delete</i></span>
                    </div>
                </div>
            </div>
        </div>
