<div class="container data-container mt-2 mb-2">
    <div class="row">
       <!-- <div class="col-md-6 d-none d-md-block text-primary"><div class="mb-2 display-2 p-2" style="height: 100%; position: relative;"><span style="position: relative; top: 25%;"><i></i></span></div></div>
...
<?php
    ...
    try {
       ...
       $formToDisplay = __data__::createDataCaptureForm($nextPage, "Theatre", array(
        ...
        ), "Create Theatre", "create", $conn, 0, array('__modal_title__' => 'Theatre Creation Report'), null);
        echo $formToDisplay;
    } catch (Exception $e)  {
...
?>
                ...
                <div class="card-footer">
                    <div class="text-center">
                        ...
                        <span class="text-muted"><i>Rule: theatre_create</i></span>
                    </div>
                </div>
            </div>
        </div>
