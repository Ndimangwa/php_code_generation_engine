...
<?php
    ...
    try {
        ...
        $id = $_GET['id'];
        $formToDisplay = __data__::createDetailsPage($nextPage, "Theatre", array('timeOfCreation', 'timeOfUpdation', 'theatreName', 'description', 'comments'), $conn, $id, null);
        echo $formToDisplay;
    } catch (Exception $e)  {
...
?>
                ...
                <div class="card-footer">
                    <div class="text-center">
                        ...
                        <span class="text-muted"><i>Rule: theatre_read</i></span>
                    </div>
                </div>
            </div>
        </div>
