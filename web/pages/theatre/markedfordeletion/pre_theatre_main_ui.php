...
$initialTabIndex = -1;
$erollback = false;
$analyticsGroup = Theatre::$__PRE_OPERATION;
?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    try {
                        ...
                        $queue1 = new PatientOperationQueue("Delta", $_REQUEST['qid'], $conn);
                    ...
                    ?>
                        ...
                        <div class="tab-container container">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item"><a tab-index="<?= Theatre::$__TAB_CONSENT_FORM ?>" class="nav-link" href="#<?= $tabConsentForm ?>" data-bs-toggle="tab">Consent Form</a></li>
                                <li class="nav-item"><a tab-index="<?= Theatre::$__TAB_MOVE_TO_OPERATION ?>" class="nav-link" href="#<?= $tabMoveToOperation ?>" data-bs-toggle="tab">Move to Operation</a></li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div id="<?= $tabConsentForm ?>" class="tab-pane fade">
                                    <h3>Consent Form</h3>
                                    <!-- Step -- 02 : Medical Examination -->
                                    <!--Add or include file-->
                                    <?php include("page_consent_form.php"); ?>
                                </div>
                                <div id="<?= $tabMoveToOperation ?>" class="tab-pane fade">
                                    <h3>Move to Operation</h3>
                                    <!--Add or include file-->
                                    <?php include("page_move_to_operation.php"); ?>
                                </div>
                            </div>
