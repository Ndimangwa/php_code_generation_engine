        ...
        <div class="offset-md-1 col-md-10">
            <div class="card">
                <div class="card-header bg-danger text-white">
                    DELETING NOTIFICATION MANAGER (CONFIRM)
                </div>
...
<?php
    ...
    try {
        ...
        $formToDisplay = __data__::createConfirmationForm($nextPage, "NotificationManager", "You are about to delete permanently, a Notification Manager; NOTE: This Action is irreversible", "Delete Notification Manager","delete", $conn, $_GET['id'], array('__id__' => $_GET['id'], '__modal_title__' => 'Delete Confirmation Report'), null);
        echo $formToDisplay;
    } catch (Exception $e)  {
...
?>
                ...
                <div class="card-footer">
                    <div class="text-center">
                        ...
                        <span class="text-muted"><i>Rule: notificationmanager_delete</i></span>
                    </div>
                </div>
            </div>
        </div>
