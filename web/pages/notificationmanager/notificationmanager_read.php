...
<?php
    ...
    try {
        ...
        $id = $_GET['id'];
        $formToDisplay = __data__::createDetailsPage($nextPage, "NotificationManager", array('timeOfCreation', 'timeOfUpdation', 'managerName', 'targetReference', 'category', 'numberOfValidDays', 'forwardURL', 'URLArguments'), $conn, $id, null);
        echo $formToDisplay;
    } catch (Exception $e)  {
...
?>
                ...
                <div class="card-footer">
                    <div class="text-center">
                        ...
                        <span class="text-muted"><i>Rule: notificationmanager_read</i></span>
                    </div>
                </div>
            </div>
        </div>
