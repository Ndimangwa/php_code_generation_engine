...
<?php
    ...
    try {
        ...
        ), "Update a Job Title","update", $conn, $_GET['id'], array('__id__' => $_GET['id'], '__modal_title__' => 'Job Title Updation Report'), null);
        echo $formToDisplay;
    } catch (Exception $e)  {
...
?>
                ...
                <div class="card-footer">
                    <div class="text-center">
                        ...
                        <span class="text-muted"><i>Rule: jobtitle_update</i></span>
                    </div>
                </div>
            </div>
        </div>
