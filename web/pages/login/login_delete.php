...
<?php
    ...
    try {
        ...
        $formToDisplay = __data__::createConfirmationForm($nextPage, "Login", "You are about to delete permanently, a user Account; NOTE: This Action is irreversible", "Deleting a User Account", "delete", $conn, $_GET['id'], array('__id__' => $_GET['id'], '__modal_title__' => 'Delete Confirmation Report'), null);
        echo $formToDisplay;
    } catch (Exception $e)  {
...
?>
                ...
                <div class="card-footer">
                    <div class="text-center">
                        ...
                        <span class="text-muted"><i>Rule: login_delete</i></span>
                    </div>
                </div>
            </div>
        </div>
