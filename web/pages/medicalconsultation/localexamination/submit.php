...
if (is_null($localExamination1)) {
    ...
    foreach ($fieldArray1 as $colname) {
        if (isset($_POST[$colname]) && (__data__::isNotEmpty($_POST[$colname]))) {
            ...
            $medicalComment1 = $localExamination1->getMyPropertyValue($colname);
...
//Build UI
echo UICardView::getSuccesfulReportCard("Local Examination", "You have successful Recorded Local Examination");
