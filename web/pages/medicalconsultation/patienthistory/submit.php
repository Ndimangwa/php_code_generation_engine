<?php
$fieldArray1 = array("chiefComplaints", "reviewOfOtherServices", "pastMedicalHistory", "familyAndSocialHistory");
...
//Build UI
echo UICardView::getSuccesfulReportCard("Patient History", "You have successful Recorded Patient History");
